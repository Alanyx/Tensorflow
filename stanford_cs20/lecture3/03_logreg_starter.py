...
if __name__ == '__main__':
    ...
    cross_entropy = tf.nn.softmax_cross_entropy_with_logits(labels=label,logits=logits,name="entropy")
    loss = tf.reduce_mean(cross_entropy,name="loss")        # computes the mean over all the examples in the batch
